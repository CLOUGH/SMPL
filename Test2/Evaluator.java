...
public class Evaluator implements Visitor {
	...
	ArrayList seq = bseq.getSeq();
	Iterator iter = seq.iterator();
	ArrayList result = null; // default result
	while(iter.hasNext()) {
	    e = (LetDef) iter.next();
            e.getVar();
	    result = (ArrayList) e.visit(this, arg);
    ...
    public Object visitExpLet(ExpLet exp, Object arg) throws Exception {
        ...
        //System.out.print("test :"+exp.getExpR().toString());
    ...
    public Object visitExpPair(ExpPair exp, Object arg) throws Exception {
        ...
        //Exp val1 = (Exp)exp.getExpL().visit(this, arg);
        //Exp val2 = (Exp)exp.getExpR().visit(this, arg);
        return exp;//new ExpPair(val1,val2);
